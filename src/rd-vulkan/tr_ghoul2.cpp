...
void R_AddGhoulSurfaces( trRefEntity_t *ent ) {
	...
	personalModel = (qboolean)((ent->e.renderfx & RF_THIRD_PERSON)/* && !tr.viewParms.isPortal*/); // todo
...
//	ri.Printf( PRINT_ALL, "Loading model with %i bones\n", mdxm->numBones );
	...
	for ( i = 0 ; i < mdxm->numSurfaces ; i++)
	{
		...
		shader_t	*sh;
		// get the shader name
		sh = R_FindShader( surfInfo->shader, lightmapsNone, stylesDefault, qtrue, qtrue );
